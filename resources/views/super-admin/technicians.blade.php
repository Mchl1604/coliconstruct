...
@section('content')
                    ...
                    <div class="card shadow-sm border-0 rounded-2 h-100" data-details-panel>
                        <div class="card-body p-3">
                            ...
                            <div class="d-none" data-panel-project>
                                ...
                                {{-- Opens the Remove Schedule dialog below. --}}
    ...
    {{-- Opened from the Schedules tab's project panel. What is being taken away:
         some days (off, then back the day after), or everything from a day
         onward. Today is the earliest either can start. Removing a technician
         from the project outright, today, is Project Details' Assigned Team. --}}
    <div class="modal fade" id="removeScheduleModal" tabindex="-1" aria-hidden="true"
        aria-labelledby="removeScheduleTitle" data-remove-schedule-modal>
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">

                <div class="modal-header align-items-start">
                    <div class="schedule-modal-heading">
                        <span class="schedule-modal-eyebrow">Remove Schedule</span>
                        <h5 class="modal-title mb-1" id="removeScheduleTitle" data-removal-technician>&nbsp;</h5>
                        <span class="technician-meta" data-removal-project></span>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <div class="btn-group w-100 mb-3" role="group" aria-label="What to remove">
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <label class="form-label small mb-1" for="removeScheduleFrom">From</label>
                            <input type="date" class="form-control" id="removeScheduleFrom"
                                data-panel-effective-date aria-label="First day removed">
                        </div>
                        <div class="col-6" data-panel-until-wrap>
                            <label class="form-label small mb-1" for="removeScheduleUntil">To</label>
                            <input type="date" class="form-control" id="removeScheduleUntil"
                                data-panel-until-date aria-label="Last day removed">
                        </div>
                    </div>

                    <p class="text-muted small mt-2 mb-0" data-panel-effective-hint></p>

                    <div class="technician-lead-panel mt-3 d-none" data-panel-lead-replacement>
                        <div class="panel-section-heading">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" data-panel-confirm-remove disabled>
                        <span class="spinner-border spinner-border-sm me-1 d-none" role="status"
